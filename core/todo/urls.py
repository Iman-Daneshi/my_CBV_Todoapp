...
from .views import TaskListView, IndexTemplateView, TaskCreateView, TaskUpdateView, TaskDeleteView, task_done_view
...
urlpatterns = [
    ...
    path('taskdone/<int:pk>', task_done_view, name='taskdone'),
